...
export class Purchase_main implements OnInit {
...
addItem()
{
  this.exp_invos.ITEMS.push({SI_NO:1,CATEGORY:'',HSN_CODE:'',ARTICLE_CODE:'',SPECS:'',BRAND:'',DESCRIPTION:'', QTY:0,UNIT:'',PRICE:0,NET_PRICE:0})
